...
const SPECS: ItemSpec[] = [
  ...
  { id: 'study_safe', roomId: 'study', lx: 3.4, lz: -3, kind: 'safe', label: "Founder's Wall-Safe", asset: ASSET_KEYS.props.fuseBox, color: [0.32, 0.3, 0.3], scale: 0.5, blockerHalf: 0.4 },
